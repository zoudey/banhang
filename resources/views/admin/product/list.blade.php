    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a href="{{ route('sanpham.tao_moi_san_pham') }}"><button class="btn btn-primary">Tạo
                                Mới</button></a>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <tbody>
                        @foreach ($product as $product)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('sanpham.sua_san_pham', $product->id) }}" method="POST">
                                        @csrf
                                        @method('GET')
                                    ...
                                    <form action="{{ route('sanpham.xoa_san_pham', $product->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
